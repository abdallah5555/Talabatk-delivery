...
export function buildAssistantReply(raw:string,ctx:AssistantContext={}):AssistantReply{
  ...
  if(includesAny(q,['تقدر تعمل ايه','بتعمل ايه','ساعدني','مساعده','مساعدة','الاوامر','الأوامر']))return{text:'ممكن تقول مثلاً: «عايز برجر تحت 200»، «فين طلبي؟»، «عايز صيدلية»، «غير عنواني»، «افتح المفضلة»، «الطلب ناقص»، «عايز أكلم المندوب»، أو «عايز أقدم كتاجر».',intent:'help'};
...
export const ASSISTANT_QUICK_PROMPTS=['عايز حاجة أطلبها','فين طلبي؟','عايز صيدلية','عايز موبايل أو شاحن','الطلب ناقص','عايز أكلم المندوب','غير عنواني','عايز أقدم كتاجر'];
