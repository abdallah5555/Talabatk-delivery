...
function MerchantDashboard(){
  ...
  return <ScrollView style={s.page} contentContainerStyle={s.content}>
    ...
    <View style={s.two}><Action title="الأذكار" icon="🤲" onPress={()=>router.push('/adhkar')}/><Action title="حسابي وتبديل الوضع" icon="👤" onPress={()=>router.push('/account')}/></View>
...
function DriverDashboard(){
  ...
  return <ScrollView style={s.page} contentContainerStyle={s.content}>
    ...
    <View style={s.two}><Action title="الأرباح والتقييمات" icon="💰" onPress={()=>router.push('/driver/center')}/><Action title="حسابي وتبديل الوضع" icon="👤" onPress={()=>router.push('/account')}/></View>
